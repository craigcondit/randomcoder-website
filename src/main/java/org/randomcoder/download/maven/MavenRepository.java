...
public class MavenRepository implements PackageListProducer, InitializingBean, DisposableBean
{
	...
	private FileSet processVersion(HttpClient client, MavenProject project, URL projectUrl, String artifactId, String version) throws PackageListException
	{
		// get filenames
	...
	private boolean statUrl(HttpClient client, URL _url) throws PackageListException
	{
