 ...
 */
@Controller("articleController") public class ArticleController {
   ...
   *
   * @param commentValidator comment validator
   */
  @Inject public void setCommentValidator(CommentValidator commentValidator) {
   ...
   */
  @Inject public void setArticleAddValidator(
   ...
   */
  @Inject public void setArticleEditValidator(
   ...
   *
   * @param permalink article permalink
   * @param user      current user
   * @param model     MVC model
   * @return article view
   */
  ...
  public String articleByIdSubmit(@PathVariable("id") long id, Principal user,
  ...
  public String articleByPermalinkSubmit(
      @PathVariable("permalink") String permalink, Principal user, Model model,
      HttpServletRequest request,
      @ModelAttribute("command") CommentCommand command, BindingResult result) {
  ...
  private String commentOnArticle(
    ...
    articleBusiness
        .createComment(command, article.getId(), userName, referrer, ipAddress,
            userAgent);
   ...
   *
   * @param model   MVC model
   * @param command article add command
   * @param result  validation result
   * @return default view
   */
   ...
   *
   * @param model   MVC model
   * @param command article edit command
   * @param result  validation result
   * @param user    current user
   * @return default view
   */
  ...
  public String editArticle(Model model,
    ...
    articleBusiness
        .loadArticleForEditing(command, command.getId(), user.getName());
   ...
   * @return default view
   */
  @RequestMapping("/article/delete") public String deleteArticle(
      @RequestParam("id") long id, Principal user) {
