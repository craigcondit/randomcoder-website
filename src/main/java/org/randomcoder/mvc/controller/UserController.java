...
@Controller("userController") public class UserController {
   ...
   */
  @Value("${user.pagesize.max}") public void setMaximumPageSize(
      int maximumPageSize) {
   ...
   */
  @Inject public void setChangePasswordValidator(
   ...
   */
  @Inject public void setUserProfileValidator(
   ...
   */
  @Inject public void setAccountCreateValidator(
   ...
   */
  @Inject @Named("userAddValidator") public void setUserAddValidator(
   ...
   */
  @Inject @Named("userEditValidator") public void setUserEditValidator(
   ...
   */
  @RequestMapping("/user") public String listUsers(Model model,
   ...
   * @return user list redirect
   */
  @RequestMapping("/user/delete") public String deleteUser(
