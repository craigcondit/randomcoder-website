 ...
 */
@Controller("commentController") public class CommentController {
  ...
  @ResponseStatus(value = NO_CONTENT) @ResponseBody public void approveComment(
  ...
  @ResponseStatus(value = NO_CONTENT) @ResponseBody
  ...
  @ResponseStatus(value = NO_CONTENT) @ResponseBody public void deleteComment(
