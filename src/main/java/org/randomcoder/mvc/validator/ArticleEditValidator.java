 ...
 */
@Component("articleEditValidator") public class ArticleEditValidator
    extends ArticleAddValidator {
  private static final String ERROR_ARTICLE_ID_REQUIRED =
   ...
   *
   * <p>
   * This validator supports {@code ArticleEditCommand} only.
   * </p>
   *
   ...
   * processing common to both classes.
   * </p>
   *
