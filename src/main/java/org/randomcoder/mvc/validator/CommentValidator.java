	...
	public void validate(Object obj, Errors errors) {
		...
		if (command.isAnonymous()) {
			...
			if (emailAddress == null) {
				errors.rejectValue("anonymousEmailAddress", ERROR_COMMENT_EMAIL_ADDRESS_REQUIRED,
						"email address required");
			} else if (!DataValidationUtils.isValidEmailAddress(emailAddress)) {
				errors.rejectValue("anonymousEmailAddress", ERROR_COMMENT_EMAIL_ADDRESS_INVALID,
