 ...
 */
@Component("userProfileValidator") public class UserProfileValidator
    implements Validator {
  private static final String ERROR_PROFILE_NULL = "error.profile.null";
  private static final String ERROR_PROFILE_EMAIL_ADDRESS_REQUIRED =
      "error.profile.emailaddress.required";
  private static final String ERROR_PROFILE_EMAIL_ADDRESS_INVALID =
      "error.profile.emailaddress.invalid";
  private static final String ERROR_WEBSITE_INVALID =
      "error.profile.website.invalid";
  ...
  @Override public void validate(Object target, Errors errors) {
    ...
    if (emailAddress == null) {
      errors.rejectValue("emailAddress", ERROR_PROFILE_EMAIL_ADDRESS_REQUIRED,
          "email address required");
    } else if (!DataValidationUtils.isValidEmailAddress(emailAddress)) {
      errors.rejectValue("emailAddress", ERROR_PROFILE_EMAIL_ADDRESS_INVALID,
