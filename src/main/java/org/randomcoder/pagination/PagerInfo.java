...
public class PagerInfo<T> {
	...
	private static final Set<String> REMOVED_PARAMS = Collections
			.unmodifiableSet(new HashSet<>(Arrays.asList("page.page", "page.size")));
	...
	private static URL urlWithParams(HttpServletRequest request, Set<String> removedParams,
	...
	private static String buildQuery(HttpServletRequest request, Set<String> removedParams,
			Map<String, String> addedParams) {
		try {
