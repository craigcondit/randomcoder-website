 ...
 * Article repository.
 */
@Repository public interface ArticleRepository
  ...
  public Page<Article> findByTagBeforeDate(Tag tag, Date endDate,
      Pageable pageable);
  ...
  public List<Article> findByTagBetweenDates(Tag tag, Date startDate,
      Date endDate);
}