 ...
 */
@Entity @Immutable @Table(name = "roles")
...
public class Role implements Serializable, Comparable<Role> {
   ...
   * @return role id
   */
  @Id @GeneratedValue(strategy = GenerationType.AUTO, generator = "roles")
  @Column(name = "role_id") public Long getId() {
    return id;
  }
   ...
   */
  @Override public int compareTo(Role o) {
