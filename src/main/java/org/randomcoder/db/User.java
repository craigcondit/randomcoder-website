...
public class User implements Serializable {
   ...
   * @return user id
   */
  @Id @GeneratedValue(strategy = GenerationType.AUTO, generator = "users")
  @Column(name = "user_id") public Long getId() {
    return id;
  }
   ...
   * @return Set of roles
   */
  @OneToMany @JoinTable(name = "user_role_link", joinColumns = {
      @JoinColumn(name = "user_id") }, inverseJoinColumns = @JoinColumn(name = "role_id"))
  @OrderBy("description") public List<Role> getRoles() {
    return roles;
  }
   ...
   */
  @Column(name = "enabled", nullable = false) public boolean isEnabled() {
    return enabled;
  }
