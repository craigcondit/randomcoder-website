...
public class Tag implements Serializable, Comparable<Tag> {
   ...
   * @return tag id
   */
  @Id @GeneratedValue(strategy = GenerationType.AUTO, generator = "tags")
  @Column(name = "tag_id") public Long getId() {
    return id;
  }
  ...
  @ManyToMany(cascade = { CascadeType.PERSIST,
      CascadeType.MERGE }, mappedBy = "tags") @OrderBy("creationDate DESC")
   ...
   */
  @Override public int compareTo(Tag o) {
