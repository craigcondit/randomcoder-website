 ...
 */
package org.randomcoder.logging;
...
public abstract class Log4jConfigurer {
   ...
   *                 (e.g. "file:C:/log4j.properties), or a plain absolute path in
   *                 the file system
  ...
  public static void initLogging(String location) throws FileNotFoundException {
    ...
    if (ResourceUtils.URL_PROTOCOL_FILE.equals(url.getProtocol())
      ...
      throw new FileNotFoundException(
          "Log4j config file [" + resolvedLocation + "] not found");
    }
   ...
   * shutdown;
   * in particular, it does not terminate on LogManager shutdown. Therefore,
   * it is
