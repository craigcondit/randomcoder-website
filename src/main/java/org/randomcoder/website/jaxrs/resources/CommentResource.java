...
public class CommentResource {
    ...
    public Response manageCommentBrowser(
            ...
            @FormParam("_verb") @DefaultValue("") String verb) throws ModerationException {

        var article = switch (verb.toUpperCase(Locale.US)) {
    ...
    @POST
    @Path("{id}/delete")
    public Response deleteCommentBrowser(@PathParam("id") long id, @FormParam("_verb") @DefaultValue("") String verb) {
        var article = switch (verb.toUpperCase(Locale.US)) {
