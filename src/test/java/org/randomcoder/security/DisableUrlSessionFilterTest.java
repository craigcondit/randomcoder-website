...
public class DisableUrlSessionFilterTest {
  ...
  @Test public void testNonHttpServletRequest() throws Exception {
    // proxy the request object so that it no longer implements
    // HttpServletRequest
    ServletRequest request = (ServletRequest) GenericProxy
        .proxy(new MockHttpServletRequest(), ServletRequest.class);
