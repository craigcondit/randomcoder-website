...
public class ChangePasswordValidatorTest {
    ...
    public void testSupports() {
        assertTrue("Validator doesn't support command class",
                validator.supports(ChangePasswordCommand.class));
    }
    ...
    public void testValidate() {
        ...
        assertEquals("Wrong error count for oldPassword", 1,
                errors.getFieldErrorCount("oldPassword"));
        ...
        assertEquals("Wrong error code", "error.changepassword.oldpassword.nomatch",
                error.getCode());
        ...
        errors = new BindException(command, "command");
        validator.validate(command, errors);
        assertEquals("Wrong error count for oldPassword", 0,
                errors.getFieldErrorCount("oldPassword"));
        ...
        assertEquals("Wrong error code", "error.changepassword.password.tooshort",
                error.getCode());
        ...
        assertEquals("Wrong error code", "error.changepassword.password.nomatch",
                error.getCode());
