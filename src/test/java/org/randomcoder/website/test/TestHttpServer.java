...
abstract public class TestHttpServer {
    ...
    public TestHttpServer() throws IOException {
        ...
        new Thread() {
            ...
            public void run() {
                try {
                    while (true) accept(socket.accept());
    ...
    abstract protected void process(Socket connection, String verb, String uri, Map<String, String> headers) throws IOException;
    ...
    protected void sendResponse(Socket connection, String status, Map<String, String> headers, InputStream data) throws IOException {
    ...
    protected void sendError(Socket connection, String status) throws IOException {
        Map<String, String> headers = getDefaultHeaders();
        headers.put("Content-type", "text/plain");
        sendResponse(connection, status, headers, new ByteArrayInputStream(status.getBytes(StandardCharsets.UTF_8)));
    }
    ...
    protected void accept(Socket connection) throws IOException {
        ...
        String uri = URLDecoder.decode(st.nextToken(), StandardCharsets.UTF_8);
