...
public class SequenceReaderTest {
  ...
  @Test(expected = IOException.class) public void testMark() throws Exception {
    seqReader.mark(1);
  }

  @Test(expected = IOException.class) public void testReset() throws Exception {
    seqReader.reset();
  }
  ...
  @SuppressWarnings("resource") @Test(expected = NullPointerException.class)
